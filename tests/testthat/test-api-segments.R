# Tests for segment-related functions

test_that("aw_get_segments() returns segment data", {
  skip_if_not_installed("httptest2")

  fixture_dir <- testthat::test_path("aw-get-segments")
  if (!dir.exists(fixture_dir)) {
    skip("Fixtures not recorded. Run: source('tests/testthat/record_all_fixtures.R')")
  }

  httptest2::with_mock_dir("aw-get-segments", {
